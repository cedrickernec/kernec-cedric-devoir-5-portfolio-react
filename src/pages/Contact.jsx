...
export default function Contact() {
  return (
    <>
      <Helmet>
        <title>Contact | John Doe - Développeur Web et Web Mobile</title>
        <meta
          name="description"
          content="Contactez-moi pour une collaboration, un projet web ou un entretien. Formulaire de contact et coordonnées professionnelles."
        />
      </Helmet>
