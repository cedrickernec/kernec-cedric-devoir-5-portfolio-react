...
export default function Portfolio() {
  return (
    <>
      <Helmet>
        <title>Portfolio | John Doe - Projets Web et Mobile</title>
        <meta
          name="description"
          content="Découvrez mes réalisations : développement web, créations de sites, intégrations, UX/UI, SEO et prototypes."
        />
      </Helmet>
